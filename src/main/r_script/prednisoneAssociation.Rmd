...
data_pyramid %>% na.omit() %>% 
  ...
  scale_x_discrete(breaks = c(1:19), labels = c(1:19) * BINWIDTH) +
  scale_y_continuous(breaks = seq(-2000, 2000, by = 500), labels = c(2000, 1500, 1000, 500, 0, 500, 1000, 1500, 2000), limits = c(-2000, 2000)) +
  scale_fill_manual(name = "gender", values = c(M = "blue", F = "red"), breaks = c("M", "F"), labels = c("male", "female")) + xlab("age (years)") +
  coord_flip() + theme_bw() + theme(panel.grid = element_blank(), legend.position = c(0.1, 0.2))
```
