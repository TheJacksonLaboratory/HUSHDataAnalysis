...
# so bump bup such HPO frequencies to positive infinite so that they are always called
...
IgE.columns <- glm_Y %>% select(contains(".IgE."))
non_IgE.columns <- glm_Y %>% select(-contains(".IgE."))
IgE.columns <- 
